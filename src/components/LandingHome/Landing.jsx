  ...
  return (
    ...
    <Container className={styles.mainContainer}>
      ...
      <Row>
        <Col md={4}>
          <Card className={styles.bodyCard}>
            <Card.Img variant="top" src="https://static.toiimg.com/thumb/imgsize-23456,msid-100636216,width-600,resizemode-4/100636216.jpg" />
            <Card.Body>
        ...
        <Col md={4}>
          <Card className={styles.bodyCard}>
            <Card.Img variant="top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTbX8hTaMYJpm4c0RtBno7asJUtPb-2PRrEw&s" />
            <Card.Body>
        ...
        <Col md={4}>
          <Card className={styles.bodyCard}>
            <Card.Img variant="top" src="https://os-wordpress-media.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2022/02/15202055/Laptop-to-Desktop-Conversion-02.jpg" />
            <Card.Body>
